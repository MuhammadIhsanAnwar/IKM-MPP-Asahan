...
$tableCheck = $conn->query("SHOW TABLES LIKE 'votes'");
if (!$tableCheck || $tableCheck->num_rows === 0) {
    http_response_code(503);
    echo json_encode([
        'success' => false,
        'message' => 'Tabel votes tidak ditemukan. Hubungi administrator.',
...
switch ($action) {
    ...
    default:
        http_response_code(400);
        $response['message'] = 'Action tidak dikenali: ' . htmlspecialchars($action);
}
